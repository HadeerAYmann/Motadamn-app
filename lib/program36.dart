...
class Program36 extends StatefulWidget {
  @override
  _ProgramState createState() => _ProgramState();
}

class _ProgramState extends State<Program36> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background36.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "الرفق بالحيوان أهم مبدأ في هذه التشيعات هو \n الاعتراف بالحاجة إلى الاعتناء برفاهية الحيوانات \nوالحاجة إلى حمايتها.  ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
