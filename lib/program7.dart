...
class _ProgramState extends State<Program7> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color(0x9000000),
                  border:
                  Border.all(width: 1.0, color:  Color(0x33707070)),
                ),
              ),
              Padding(
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "هؤلاء هم المدينون، في حال لم يكن لديهم ما يمكن \nأن يوفوا به ديونهم، فهم يعطون من مال الزّكاة \nما يسمح لهم بإيفاء ديونهم ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
