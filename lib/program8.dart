...
class _ProgramState extends State<Program8> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background8.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "هو نشاط خيري يأتي لدعم شرائح الأيتام بشكل عام \nوتقديم مساعدات مادية خيرية من شأنها دعم متلقى\n المساعدة في بناء حياة جديدة ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
