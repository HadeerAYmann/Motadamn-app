...
class Program32 extends StatefulWidget {
  @override
  _ProgramState createState() => _ProgramState();
}

class _ProgramState extends State<Program32> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background32.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "تقديم ما يحتاجه ذوي القدرات الخاصة من أحتياجات\n مختلفة بأفضل أمكانية تطوعية لأكتشاف أمكانيتهم  \nو دمجهم في المجتمع لتغيير نظرة المجتمع لهم  ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
