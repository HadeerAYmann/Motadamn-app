...
class _ProgramState extends State<Program21> {
  int _currentIndex = 0;
  @override
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background21.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "زكاه الخارج من الارض هنسعدك لتوفير المستلزمات\n اللازمة لحياة أفضل  ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
