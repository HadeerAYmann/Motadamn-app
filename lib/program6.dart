...
class _ProgramState extends State<Program6> {
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "اليتيم هو الإنسان الذي يموت عنه والده وهو طفل صغير قبل \nالبلوغ  وقد حثّ الدين على رعاية اليتيم والعطف عليه والذي\n جعل ممن يرعاه جار النبي محمد (ص) في الجنة ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
