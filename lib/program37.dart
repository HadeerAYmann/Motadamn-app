...
class Program37 extends StatefulWidget {
  @override
  _ProgramState createState() => _ProgramState();
}

class _ProgramState extends State<Program37> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background37.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "خفض معدلات الوفيات الناجمة عن الحروق بفضل\n تنفيذ مجموعة من الاستراتيجيات الوقائية وتحسين \n رعاية الأشخاص المصابين بالحروق ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
