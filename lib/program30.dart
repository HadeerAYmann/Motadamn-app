...
class _ProgramState extends State<Program30> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background30.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "الهدف من عمليات القلب المفتوح وضع خطة فردية لمساعدتك \nعلى استعادة القوة لمنع حالتك من التدهور  ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
