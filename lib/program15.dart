...
class _ProgramState extends State<Program15> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background15.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "عباره عن حملات اغاثة سريعه للقرى الفقيره \n يتم من خلالها إعادة تأهيل المنازل التي \nمساحتها فى حدود متوسط",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
