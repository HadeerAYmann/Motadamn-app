...
class Program31 extends StatefulWidget {
  @override
  _ProgramState createState() => _ProgramState();
}

class _ProgramState extends State<Program31> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background31.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "بتوفير العلاج شهرياً للامراض الخطيره والتى لم\n تقوم الدولة بتوفيرها للمرضى الغير قادرين ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
