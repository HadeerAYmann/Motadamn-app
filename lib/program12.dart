...
class _ProgramState extends State<Program12> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background12.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "تســتهدف المبــادرة توفيــر المــواد الغذائيــة\n للفئــات الأكثــر احتياجـاً مـن أهالـي قـرى \nونجـوع مصـر بالمجـان ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
