...
import 'package:flutterapp/all_beneficial.dart';
...
//
                ...
                Padding(
                  padding: EdgeInsets.only(top: 350, left: 79),
                  child:
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 10.0, right: 70, top: 520),
                  child: Container(
                    width: 300,
                    margin: EdgeInsets.all(12.0),
                    child: RaisedButton(
