...
class _ProgramState extends State<Program11> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background11.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "اهو نشاط لرعاية الاطفال فى وضعية الشارع والأطفال\n المعرضين للانحراف والعمل علي تأهيلهم حتى تتاح لهم \nالفرصة في حياة سوية وطبيعية وآمنة ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
