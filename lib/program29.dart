...
class _ProgramState extends State<Program29> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background29.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      " يتضمن العلاج عادةً مزيجًا من العلاج السلوكي أو العلاج \nالسلوكي المعرفي أو علاج باللعب أو العلاج\n النفسي بالتحليل، أو باستخدام الدواء",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
