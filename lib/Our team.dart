            ...
            children: <Widget>[
              Stack(
                children: <Widget>[
                  Padding(
                    padding:
                    EdgeInsets.only(top: 15.0, right: 177),
                    child: Row(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 290, left: 15,right: 30),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 310, left: 40,right: 35),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 350, left: 50,right: 50),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Container(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 450, left: 65,right: 45),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 470, left: 70,right: 60),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Front-End\nDeveloper',style: TextStyle(fontSize: 10,fontFamily: 'Simple'),),
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 510, left: 20,right: 20),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Container(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 610, left: 33,right: 20),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 630, left: 25,right: 23),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
