...
class _ProgramState extends State<Program4> {
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "تحصل المستفيدة بالمشروع على مبلغ 600 جنيه شهريا  طوال\nً فترة حمل الرأس الأصلية و بعد بلوغ المولود 6 أشهر كاملة \n يصبح من حق الحالة التصرف سواء بالبيع أو التربية ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
