...
class Program35 extends StatefulWidget {
  @override
  _ProgramState createState() => _ProgramState();
}

class _ProgramState extends State<Program35> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background35.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "الهدف من حضانات الاطفال ضمان التدفق المستمر\n للمعلومات فضلا عن التقنيات المبتكرة، التي تواكب\n احتياجات الطفل المتغيِّرة  ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
