...
class _ProgramState extends State<Program24> {
            ...
            children: <Widget>[
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image(
                    image: AssetImage('images/background24.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "تعد العمليات الجراحية من أكثر الاحتياجات العلاجية\n المكلفة حيث أنها تشمل عناصر عديدة مثل \nتكاليف مستشفى ومستلزمات طبية ",
                      style: TextStyle(
                        fontFamily: 'Century',
                        fontSize: 18,
